...
A lowcodefml mod is a plain zip: META-INF/mods.toml + pack.mcmeta + data/**
(+ logo, if present). Everything under src/ is zipped verbatim. Output ->
build/deeperdarker_emc-<version>+forge-1.20.1.jar.
